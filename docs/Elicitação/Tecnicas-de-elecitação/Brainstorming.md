...
| BS13 (RF13)| Histórico de Pesquisas e Serviços Recentes                         |
...
|-------------|-----------------------------------------------------------------------------------------------|
| BS14 (RNF01)| Interface intuitiva e fácil de usar                                                           |
| BS15 (RNF02)| Compatibilidade com dispositivos móveis                                                       |
| BS16 (RNF03)| Alta segurança no tratamento de dados (confiança por ser app do governo)                     |
| BS17 (RNF04)| Área educacional sobre processos do DETRAN (explicações, vídeos, etc.)                        |
| BS18 (RNF05)| Acessibilidade: fonte grande, alto contraste, modo noturno                                    |
| BS19 (RNF06)| Leitor de tela e assistente por voz para pessoas cegas                                        |
| BS20 (RNF07)| Sistema de avaliação com estrelas baseado em comprovante de uso real (ex-alunos)             |
| BS21 (RNF08)| Propaganda mais efetiva para aumentar o conhecimento da existência do app                     |
| BS22 (RNF09)| Layout com foco em simplicidade e legibilidade                                                |
