...
Esse artefato mostra como foi montado a lista de verificação dos lexicos

## Objetivo

Esse artefato tem como objetivo documentar a lista de verificação dos lexicos
...
A **tabela 1** descreve o checklist dos lexicos

<font size="3"><p style="text-align: center">**Tabela 1 **- Checklist técnica dos lexicos</p></font>
...
|  1.1   | 14/05/2025 | criação da tabela de criterios |  [Giovana Barbosa](https://github.com/gio221)   | [Gabriel Mendes](https://github.com/gbevi)|