...
|                  Integrante                  |                          Cenário                          |
| :------------------------------------------: | :-------------------------------------------------------: |
| [Giovana Barbosa](https://github.com/gio221) |  Pesquisa utilizando integração por voz no DeepSeek (#UC03)   |
| [Giovana Barbosa](https://github.com/gio221) |         Acessar configurações para alterar o tema do Sistema  |

## Pesquisa utilizando integração por voz no DeepSeek (#UC03) 
