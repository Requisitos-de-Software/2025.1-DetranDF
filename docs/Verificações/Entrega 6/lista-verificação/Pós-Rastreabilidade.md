# Lista de Verificação da pós-rastreabilidade

## Introdução
Esse documento tem como objetivo documentar a lista de verificação da pós-rastreabilidade

## Checklist pós-rastreabilidade
A tabela 1 descreve o checklist do artefato da pós-rastreabilidade

    Tabela 1: Checklist da pós-rastreabilidade
