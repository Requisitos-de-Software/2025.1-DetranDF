...
| L14 - Veículo com ocorrência registrada | Estado | Indica que o sistema detectou e notificou um registro de roubo ou recuperação do veículo | Informa situação crítica de segurança, permitindo ação imediata do usuário | Roubo detectado, Veículo recuperado | [Maria Eduarda](https://github.com/maaduh) |
